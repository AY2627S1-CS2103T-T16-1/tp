...
public class RemarkCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + ": Replaces the remark of the person identified "
            + "by the index number in the displayed person list. "
            + "An empty or omitted remark removes the existing remark.\n"
    ...
    /**
     * Constructs a command to replace the remark of the person at {@code index} in the displayed list.
     */
    ...
    /**
     * Returns feedback describing whether the remark was added or removed.
     */
