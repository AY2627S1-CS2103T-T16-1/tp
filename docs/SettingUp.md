...
1. **Verify the setup**:
   1. Run `seedu.tab.Main` and try a few commands.
...
1. **Learn the design**
   ...
   When you are ready to start coding, we recommend that you get some sense of the overall design by reading about [TAB's architecture](DeveloperGuide.md#architecture).

1. **Do the tutorials**
   These upstream AddressBook-Level3 tutorials will help you get acquainted with the codebase inherited by TAB.
