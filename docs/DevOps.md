...
* **`shadowJar`**: Uses the Shadow plugin to create the fat JAR file `build/libs/tab.jar`.<br>
...
1. Update the version number in [`MainApp.java`](https://github.com/AY2627S1-CS2103T-T16-1/tp/blob/master/src/main/java/seedu/tab/MainApp.java).
